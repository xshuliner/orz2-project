      ...
      <section className='privacy-layout'>
        ...
        <article className='privacy-article'>
          <section id='overview'>
            ...
            <p className='!m-0'>
              本协议说明 ORZ2
              在提供在线工具、产品展示、定制合作沟通和网站分析时可能涉及的信息处理方式。首版联系和主体信息为可替换占位，正式上线前应替换为真实运营主体。
            </p>
          </section>
          <section id='collection'>
            <h2 className='!m-0 !mb-[10px] text-[28px]'>我们收集的信息</h2>
            <p className='!m-0'>
              我们尽量减少信息收集。用户主动联系时，可能提供邮箱、需求描述或项目背景；访问网站时，浏览器可能传递设备类型、页面路径、来源页面和基础日志信息。
            </p>
          </section>
          <section id='usage'>
            <h2 className='!m-0 !mb-[10px] text-[28px]'>信息使用方式</h2>
            <p className='!m-0'>
              信息主要用于回复咨询、改进工具体验、排查异常、衡量页面质量和维护服务安全。我们不会出售用户个人信息，也不会用不必要的信息限制用户访问公开页面。
            </p>
          </section>
          <section id='cookies'>
            <h2 className='!m-0 !mb-[10px] text-[28px]'>Cookie 与本地存储</h2>
            <p className='!m-0'>
              ORZ2 可使用必要 Cookie
              或本地存储保存偏好设置、减少重复输入，并在接入分析或广告服务时提供必要的提示与配置入口。
            </p>
          </section>
          <section id='third-party'>
            <h2 className='!m-0 !mb-[10px] text-[28px]'>第三方服务与广告</h2>
            <p className='!m-0'>
              后续如接入 Google
              Ads、统计分析、托管服务或邮件服务，相关第三方可能依据其政策处理必要数据。我们会在页面中保持隐私入口、联系渠道和广告说明清晰可见。
            </p>
          </section>
          <section id='rights'>
            <h2 className='!m-0 !mb-[10px] text-[28px]'>用户权利</h2>
            <p className='!m-0'>
              用户可以请求了解、更正或删除通过联系渠道提交的信息，也可以通过浏览器设置管理
              Cookie。我们会在合理时间内响应与隐私相关的请求。
            </p>
          </section>
          <section id='contact'>
            <h2 className='!m-0 !mb-[10px] text-[28px]'>联系我们</h2>
            <p className='!m-0'>
              如对本协议或数据处理方式有疑问，请联系{' '}
              <a
